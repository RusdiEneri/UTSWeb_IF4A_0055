...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        $sql = 'UPDATE services SET title = :title, description = :description, image_url = :image_url, price = :price WHERE id = :id';
      ...
      <div class="container-fluid">
        ...
        <form method="post" action="">
          ...
          <div class="d-flex gap-2">
            <button class="btn btn-velora" type="submit">Simpan Perubahan</button>
